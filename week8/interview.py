...
def generate_person_names(count):
    """Generate a list of culturally-diverse persons as dictionaries.

    The name pool is effectively 2000 unique combinations from:
    ...
    Returns:
        list[dict[str, str]]: list of {"first": ..., "last": ...} dictionaries.
